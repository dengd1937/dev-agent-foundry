...
- File owns unrelated concerns (e.g., HTTP handlers + DB operations + business rules in one file)
...
- Adding a new behavior requires editing many if/elif blocks
...
- Subclass checks for concrete type or raises NotImplementedError for base method
...
- Abstract base classes with many methods, most unused by implementers
- Callers depend on broad protocols for narrow needs
...
| Smell | Signs |
|-------|-------|
| **Long method** | Function > 50 lines, multiple levels of nesting |
...
| **Primitive obsession** | Using str/int instead of domain types |
